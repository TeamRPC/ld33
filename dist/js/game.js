...
},{"./states/boot":2,"./states/fail":3,"./states/gameover":4,"./states/menu":5,"./states/play":6,"./states/preload":7}],2:[function(require,module,exports){
...
GameOver.prototype = {
  ...
  create: function () {
    this.title = this.game.add.sprite(0, 0, 'lose');
  },
  update: function () {
